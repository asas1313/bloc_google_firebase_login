...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  AuthBloc({required this.authRepository}) : super(UnAuthenticated()) {
    // When User Presses the LogIn Button, we will send the LogInRequested Event to the AuthBloc to handle it and emit the Authenticated State if the user is authenticated
